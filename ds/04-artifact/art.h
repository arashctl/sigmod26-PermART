            ...
            if (GET_LOCK(p).try_lock(tid, [=] {
                    ...
                    if (c == nullptr) {
                        ...
                        *cptr = (node *)new_l;
                        ...
                        #ifdef MEASURE_COW_TIME
                        if (verlib::measuring_cow_time) {
                            auto cow_end = art_rdtsc();
                            auto cow_duration = cow_end - cow_start;
                            GSTATS_ADD(tid, insert_time_new_node, cow_duration);
                        } 
                        #endif
                        ...
                        if (l->size < max_small_leaf_size) {
                            ...
                            *cptr =
                            ...
                            if (verlib::measuring_cow_time) {
                                auto cow_end = art_rdtsc();
                                auto cow_duration = cow_end - cow_start;
                                GSTATS_ADD(tid, insert_time_leaf_cow, cow_duration);
                            }
                            #endif
                            ...
                            *cptr = (node *)new_s;
                            ...
                            if (verlib::measuring_cow_time) {
                                auto cow_end = art_rdtsc();
                                auto cow_duration = cow_end - cow_start;
                                GSTATS_ADD(tid, insert_time_split_cow, cow_duration);
                            }
                            #endif
